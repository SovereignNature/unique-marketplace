  ...
  return (
    <main className='faq-page'>
        ...
        <div className="unique-card">
            ...
            <p className='about-sadu'>This batch of NFTs is a pre-release for Polkadot Kusama. A total of 1000 NFTs will be released on multiple blockchain networks. This marketplace was built in partnership with Sovereign Nature Initiative (SNI) and Unique Network. SNI takes a 5% commission on every NFT.</p>
